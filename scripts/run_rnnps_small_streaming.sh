...
# Dataset: "Skylion007/openwebtext" or "karpathy/fineweb-edu-100b-shuffle"
...
RUN_NAME="rnnps-small-${DATASET_SHORT}-lr${LR}-rlr${RNNPS_LR}-b1_${BETA1}-b2_${BETA2}-wd${WD}-rwd${RNNPS_WD}-it${MAX_ITERS}"
# Log file
...
torchrun --standalone --nproc_per_node=${GPUS} \
      ...
      config/train_gpt2_small_rnnps_streaming.py \
