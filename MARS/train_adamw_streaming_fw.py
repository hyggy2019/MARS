"""
Adapted from https://github.com/Liuhong99/Sophia/blob/main/train_adam.py
"""
import os
import time
import math
...
# optimizer
optimizer = model.configure_optimizers(optimizer_name, weight_decay, learning_rate, (beta1, beta2), device_type)
if init_from == 'resume':
