...
# optimizer2 = RNNPS([p for p in params if p.ndim == 2], lr=rnnps_learning_rate, rank=ddp_rank, world_size=ddp_world_size)
# optimizers = [optimizer1, optimizer2]
optimizer = CombinedOptimizer(params, [AdamW, RNNPS], [{'lr': learning_rate, 'betas': (beta1, beta2), 'weight_decay': weight_decay},
                                                        {'lr': rnnps_learning_rate, 'weight_decay': rnnps_weight_decay}])
if init_from == 'resume':
